...
import { FaBox, FaPlus, FaTimes, FaUser } from "react-icons/fa";

const CreateOrderTravelAgent = () => {
  ...
  const fetchPackages = async () => {
    try {
      const response = await api.get(
        "/packages?status=published&my_packages=true",
      );
  ...
  if (loading) {
    return (
      <TravelLayout title="Buat Pemesanan Baru">
...
export default CreateOrderTravelAgent;
