...
const OrderTravelAgent = () => {
  ...
  const getOrderActions = (order) => {
    const actions = [
      {
        type: "view",
        onClick: () => navigate(`/travel/orders/detail/${order.id}`),
        color: "text-blue-500",
        title: "Detail",
      },
    ];
  ...
  return (
    <TravelLayout title="Manajemen Pemesanan Produk">
      {/* Custom Header for Travel Agent */}
      <div className="mb-6 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Kelola pemesanan untuk Produk anda
            </p>
          </div>
        </div>
        <div className="flex gap-2">
          ...
          >
            <FaPlus /> Buat Pemesanan
          </button>
        </div>
      </div>

      {/* Filter Section using FilterGroup component */}
      <div
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        {loading ? (
          ...
          <div className="p-8 text-center text-gray-500">
            Tidak ada data pemesanan untuk Produk Anda
          </div>
        ) : (
...
export default OrderTravelAgent;
